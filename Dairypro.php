...
if (isset($_POST['save_the_form_data'])) {
  ...
  $id1 = isset($_POST['id_1']) ? $_POST['id_1'] : '';
    $id2 = isset($_POST['id_2']) ? $_POST['id_2'] : '';
    $id3 = isset($_POST['id_3']) ? $_POST['id_3'] : '';
    $id4 = isset($_POST['id_4']) ? $_POST['id_4'] : '';
    $id5 = isset($_POST['id_5']) ? $_POST['id_5'] : '';
